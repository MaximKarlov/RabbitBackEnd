...
console.log("Config",config)
  ...
  function calcSignAccess(clientId, accessToken, timestamp, nonce, signStr, secret) {
    // Concatenate: clientId + timestamp + nonce + signStr
  ...
  // Calculate signature
  const sign = calcSignAccess(clientId, accessToken, timestamp, nonce, signResult.signUrl, secret);
...
// Export functions
module.exports = { generateAuth, generateTokenAuth, calcSign, stringToSign, getTime };
